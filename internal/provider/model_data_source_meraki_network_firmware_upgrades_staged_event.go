...
// It emits a separate model - DataSourceNetworkFirmwareUpgradesStagedEvent - used only by the data source, always including every
...
type DataSourceNetworkFirmwareUpgradesStagedEvent struct {
	...
	Stages                                       []DataSourceNetworkFirmwareUpgradesStagedEventStages `tfsdk:"stages"`
}

type DataSourceNetworkFirmwareUpgradesStagedEventStages struct {
...
func (data DataSourceNetworkFirmwareUpgradesStagedEvent) getPath() string {
...
func (data *DataSourceNetworkFirmwareUpgradesStagedEvent) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("stages"); value.Exists() && value.Value() != nil {
		data.Stages = make([]DataSourceNetworkFirmwareUpgradesStagedEventStages, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceNetworkFirmwareUpgradesStagedEventStages{}
