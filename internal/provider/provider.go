...
func (p *MerakiProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewNetworkFirmwareUpgradesStagedEventResource,
		NewNetworkFirmwareUpgradesStagedEventsDeferResource,
		NewNetworkFirmwareUpgradesStagedEventsRollbacksResource,
		NewNetworkFirmwareUpgradesStagedGroupResource,
		NewNetworkFirmwareUpgradesStagedStageResource,
...
func (p *MerakiProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewNetworkFirmwareUpgradesStagedEventDataSource,
		NewNetworkFirmwareUpgradesStagedGroupDataSource,
		NewNetworkFirmwareUpgradesStagedStageDataSource,
