...
// It emits a separate model - DataSourceNetworkFirmwareUpgradesStagedStage - used only by the data source, always including every
...
type DataSourceNetworkFirmwareUpgradesStagedStage struct {
	Id        types.String                                       `tfsdk:"id"`
	NetworkId types.String                                       `tfsdk:"network_id"`
	Json      []DataSourceNetworkFirmwareUpgradesStagedStageJson `tfsdk:"_json"`
}

type DataSourceNetworkFirmwareUpgradesStagedStageJson struct {
...
func (data DataSourceNetworkFirmwareUpgradesStagedStage) getPath() string {
...
func (data *DataSourceNetworkFirmwareUpgradesStagedStage) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("_json"); value.Exists() && value.Value() != nil {
		data.Json = make([]DataSourceNetworkFirmwareUpgradesStagedStageJson, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceNetworkFirmwareUpgradesStagedStageJson{}
